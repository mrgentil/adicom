                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 primary">
                        <div class="right-sidebar">
                            <iframe width="560" height="315" src="{{$academie->link}}"
                                    title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media;
                            gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            <div class="single-event-content-wrap"><br><br>
                                <h4>
                                    {{$academie->title}}
                                </h4><br><br>
                                <p>
...
{{--                                    </span>--}}
{{--                                <p>--}}
{{--                                    "Mus delectus incidunt tincidunt, placerat nobis dolore maiores etiam porttitor! Quo--}}
{{--                                    auctor laudantium praesent eleifend.Quia dignissimos quidem lectus nulla. "--}}
{{--                                </p>--}}
{{--                            </div>--}}
...
{{--                                    Massa amet tenetur error? Nostra duis illum bibendum asperiores lobortis, tortor--}}
{{--                                    exercitation risus nec? Arcu voluptatum. Anim consequatur? A ducimus? Elementum--}}
{{--                                    platea illo, class tempore. Iste laudantium ullam temporibus et.--}}
{{--                                </p>--}}
                    ...
                    <div class="col-lg-4 secondary">
                        <div class="sidebar">
                            <aside class="widget author_widget">
                                <h6 class="title-divider-center">A savoir +</h6>
                                <div class="widget-content text-center">
                                    <div class="profile">
                                        <figure class="avatar">
                                            <img src="{{asset('assets/img/Paul.jpg')}}" alt="">
                                        </figure>
